...
// Si 1er argument est égal 'deux'
if (process.argv[2] === 'deux') {
  // Afficher un deuxieme dé
  const resultat2 = lancerDe()

  console.log(resultat2 + ' (' + deTexte[resultat2] + ')')
  console.log(deDessin[resultat2])
}